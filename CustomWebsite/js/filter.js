function myFunction() {
    ...
    cards = cardContainer.getElementsByClassName("card"); //array of products (cards) to be displayed
...
function classFilter(type) {
    var dishType;
    dishType = document.getElementsByClassName(type); //array of types of food
    for (i = 0; i < dishType.length; i++) {
        dishType[i].style.display = "";
    }
    cardsCollection = document.getElementsByClassName("card"); //array of food_name
